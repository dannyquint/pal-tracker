...
public Map<String,String> getEnv(){
   Map<String, String> envsettings = new HashMap<>();
   envsettings.put("PORT", this.PORT);
   envsettings.put("MEMORY_LIMIT", this.MEMORY_LIMIT);
   envsettings.put("CF_INSTANCE_INDEX", this.CF_INSTANCE_INDEX);
   envsettings.put("CF_INSTANCE_ADDR", this.CF_INSTANCE_ADDR);
